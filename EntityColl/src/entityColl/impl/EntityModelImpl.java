 ...
 * </p>
 * <ul>
 *   <li>{@link entityColl.impl.EntityModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link entityColl.impl.EntityModelImpl#getCollections <em>Collections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityModelImpl extends MinimalEObjectImpl.Container implements EntityModel {
	...
	protected EClass eStaticClass() {
		return EntityCollPackage.Literals.ENTITY_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntityCollPackage.ENTITY_MODEL__NAME, oldName, name));
	}
	...
	public EList<Collection> getCollections() {
		if (collections == null) {
			collections = new EObjectContainmentEList<Collection>(Collection.class, this, EntityCollPackage.ENTITY_MODEL__COLLECTIONS);
		}
		return collections;
	}
